...
Version  : 18.04.3
Release  : 1
URL      : https://github.com/KDE/konsole/archive/v18.04.3.tar.gz
Source0  : https://github.com/KDE/konsole/archive/v18.04.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532102666
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libkonsoleprivate.so.18.04.3
