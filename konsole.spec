...
Source0  : https://download.kde.org/stable/release-service/19.12.3/src/konsole-19.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.3/src/konsole-19.12.3.tar.xz.sig
...
%prep
%setup -q -n konsole-19.12.3
cd %{_builddir}/konsole-19.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583453234
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/konsole-19.12.3/COPYING %{buildroot}/usr/share/package-licenses/konsole/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/konsole-19.12.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/konsole/fcbf818f92ef8679a88f3778b12b4c8b5810545b
cp %{_builddir}/konsole-19.12.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/konsole/ba8966e2473a9969bdcab3dc82274c817cfd98a1
pushd clr-build
%make_install
popd
%find_lang konsole
...
/usr/lib64/libkonsoleprivate.so.19.12.3
