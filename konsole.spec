...
Version  : 18.07.80
Release  : 2
URL      : https://github.com/KDE/konsole/archive/v18.07.80.tar.gz
Source0  : https://github.com/KDE/konsole/archive/v18.07.80.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532646746
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libkonsoleprivate.so.18.07.80
