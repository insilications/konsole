...
Version  : 18.12.0
Release  : 11
URL      : https://github.com/KDE/konsole/archive/v18.12.0.tar.gz
Source0  : https://github.com/KDE/konsole/archive/v18.12.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1544886334
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libkonsoleprivate.so.18.12.0
