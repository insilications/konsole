...
Version  : 18.08.3
Release  : 8
URL      : https://github.com/KDE/konsole/archive/v18.08.3.tar.gz
Source0  : https://github.com/KDE/konsole/archive/v18.08.3.tar.gz
...
%package abi
Summary: abi components for the konsole package.
Group: Default

%description abi
abi components for the konsole package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1541691950
mkdir -p clr-build
pushd clr-build
%cmake ..
...
cp COPYING.Unicode %{buildroot}/usr/share/package-licenses/konsole/COPYING.Unicode
pushd clr-build
%make_install
popd
...
%files abi
%defattr(-,root,root,-)
/usr/share/abi/libkonsoleprivate.so.18.08.3.abi
/usr/share/abi/libkonsoleprivate.so.18.abi
...
/usr/lib64/libkonsoleprivate.so.18.08.3
...
/usr/share/package-licenses/konsole/COPYING.Unicode
